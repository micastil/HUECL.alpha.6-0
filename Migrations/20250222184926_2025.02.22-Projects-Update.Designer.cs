...
namespace HUECL.alpha._6_0.Migrations
{
    ...
    [Migration("20250222184926_2025.02.22-Projects-Update")]
    partial class _20250222ProjectsUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HUECL.alpha._6_0.Models.Projects.Interaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HUECL.alpha._6_0.Models.Projects.InteractionType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HUECL.alpha._6_0.Models.Projects.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HUECL.alpha._6_0.Models.Projects.ProjectDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HUECL.alpha._6_0.Models.Projects.ProjectDocumentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProjectDocumentTypes");
                });

            modelBuilder.Entity("HUECL.alpha._6_0.Models.Projects.ProjectSector", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HUECL.alpha._6_0.Models.Projects.ProjectStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HUECL.alpha._6_0.Models.Projects.ProjectUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("CanAddInteractions")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("HUECL.alpha._6_0.Models.Projects.Reminder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HUECL.alpha._6_0.Models.Projects.Interaction", b =>
                {
                    b.HasOne("HUECL.alpha._6_0.Areas.Identity.Data.ApplicationUser", "CreatedByUser")
                        .WithMany("CreatedInteractions")
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("HUECL.alpha._6_0.Models.Projects.InteractionType", "InteractionType")
                        .WithMany("Interactions")
                        .HasForeignKey("InteractionTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HUECL.alpha._6_0.Models.Projects.Project", "Project")
                        .WithMany("Interactions")
            ...
            modelBuilder.Entity("HUECL.alpha._6_0.Models.Projects.Project", b =>
                {
                    ...
                    b.HasOne("HUECL.alpha._6_0.Areas.Identity.Data.ApplicationUser", "Owner")
                        .WithMany("OwnedProjects")
                        .HasForeignKey("OwnerId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("HUECL.alpha._6_0.Models.Projects.ProjectSector", "ProjectSector")
                        .WithMany("Projects")
                        .HasForeignKey("ProjectSectorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HUECL.alpha._6_0.Models.Projects.ProjectStatus", "ProjectStatus")
                        .WithMany("Projects")
            ...
            modelBuilder.Entity("HUECL.alpha._6_0.Models.Projects.ProjectDocument", b =>
                {
                    b.HasOne("HUECL.alpha._6_0.Models.Projects.ProjectDocumentType", "DocumentType")
                        .WithMany("Documents")
            ...
            modelBuilder.Entity("HUECL.alpha._6_0.Models.Projects.ProjectUser", b =>
                {
                    ...
                    b.HasOne("HUECL.alpha._6_0.Areas.Identity.Data.ApplicationUser", "User")
                        .WithMany("ProjectUsers")
            ...
            modelBuilder.Entity("HUECL.alpha._6_0.Models.Projects.Reminder", b =>
                {
                    b.HasOne("HUECL.alpha._6_0.Areas.Identity.Data.ApplicationUser", "AssignedUser")
            ...
            modelBuilder.Entity("HUECL.alpha._6_0.Models.SaleInvoice", b =>
                {
                    b.HasOne("HUECL.alpha._6_0.Models.SaleDelivery", "SaleDelivery")
                        .WithOne("SaleInvoice")
                        .HasForeignKey("HUECL.alpha._6_0.Models.SaleInvoice", "SaleDeliveryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
